...
?>
<div class="col-md-2 img-thumbnail" style="margin: 14px; min-height: 300px;">
    <a href="<?= $item_page ?>"><img src="<?= $small_pic_path ?>" title="<?= $item_title ?>" class="img-responsive"></a>
    <br>
    <h6><a href="<?= $item_page ?>" style="color: black;"><?= $item_title ?></a></h6>
    <div style="clear: both; color: black; font-weight: bold;"><?= $currency_symbol.number_format($item_price,2) ?>
