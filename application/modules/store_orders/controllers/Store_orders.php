...
{
    //NOTE: notifies cutomer when an order status has been updated
    ...
    // build a message for customer
    $msg = 'Order <b>\''.$order_ref.'\'</b> has just been updated. The new status for your order is <b>'.$status_title.'</b>.';
...
{
    // find out the total amount taken in from this order
...
{
    //this get called from the Paypal IPN listener, when an order is placed
    $this->load->module('site_security');
